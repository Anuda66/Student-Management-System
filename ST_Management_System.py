...
class StudentManagementSystem:
    def __init__(self, root):
        ...
        title_label = tk.Label(self.root, text="-Student Management System-", font=("sans-serif", 30), bg="green", fg="white", width=1000,height=2)
        title_label.grid(row=0, column=0, columnspan=5, pady=(0, 40))

       #student's details 
        self.groupbox_student_details = tk.LabelFrame(self.root, text="Student's Details", bg="#d9fbd6", font=("sans-serif", 18))   
        self.groupbox_student_details.grid(row=1, column=0, padx=10, pady=10, sticky="nsew")

        
        self.label_name = tk.Label(self.groupbox_student_details, text="Name:", bg="#d9fbd6", font=("sans-serif", 11))
        self.entry_name = tk.Entry(self.groupbox_student_details, width=25)

        self.label_id = tk.Label(self.groupbox_student_details, text="Student ID:", bg="#d9fbd6", font=("sans-serif", 11))
        self.entry_id = tk.Entry(self.groupbox_student_details, width=25)

        self.label_gender = tk.Label(self.groupbox_student_details, text="Gender:", bg="#d9fbd6", font=("sans-serif", 11))
        ...
        self.label_age = tk.Label(self.groupbox_student_details, text="Age:", bg="#d9fbd6", font=("sans-serif", 11))
        self.entry_age = tk.Entry(self.groupbox_student_details, width=25)

        self.label_degree = tk.Label(self.groupbox_student_details, text="Degree Program:", bg="#d9fbd6", font=("sans-serif", 11))
        ...
        #buttons 
        self.add_button = tk.Button(self.groupbox_student_details, text="Add", command=self.add_student, width=20, bg="#13470f", fg="white")
        self.view_button = tk.Button(self.groupbox_student_details, text="View", command=self.view_students, width=20, bg="#13470f", fg="white")
        self.search_button = tk.Button(self.groupbox_student_details, text="Search", command=self.search_student, width=20, bg="#13470f", fg="white")
        self.delete_button = tk.Button(self.groupbox_student_details, text="Delete", command=self.delete_student, width=20, bg="#13470f", fg="white")
        self.update_button = tk.Button(self.groupbox_student_details, text="Update", command=self.update_student, width=20, bg="#13470f", fg="white")
       ...
       #table details
        ...
        self.tree.tag_configure("evenrow", background="#c6f9c1")
        self.tree.tag_configure("oddrow", background="#ecfdea")

        #buttons align
        self.add_button.grid(row=0, column=5, padx=100, pady=10, columnspan=1)
        self.view_button.grid(row=1, column=5, padx=100, pady=10, columnspan=1)
        self.search_button.grid(row=2, column=5, padx=100, pady=10, columnspan=1)
        self.delete_button.grid(row=3, column=5, padx=100, pady=10, columnspan=1)
        self.update_button.grid(row=4, column=5, padx=100, pady=10, columnspan=1)
